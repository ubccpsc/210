...
- **Copy, Shallow** — [Encapsulating What Varies § When References Escape](/part2/03_encapsulation#when-references-escape) <!-- NOTE: we don't cover deep copying yet? -->
